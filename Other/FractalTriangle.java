...
public class FractalTriangle 
{
    ...
    private FractalTriangle[] children = new FractalTriangle[ 3 ];
     ...
     *
     * @param depth Maximum depth for fractal triangles.
    ...
    public FractalTriangle( int depth, ATriangle tri, int height )
    {
        ...
        // modular as possible.
        /////////////////////////////////////////////////////
        _tri.setColor( colors[ depth - 1 ] );
        if( depth < maxDepth && depth < 6 && height >= 7 )
        {
            Point[] points = _tri.getPoints();
            ATriangle child1Tri = makeTriangle( points[ 0 ], points[ 1 ] );
            children[ 0 ] = new FractalTriangle( child1Tri, this, depth + 1 );
            
            ATriangle child2Tri = makeTriangle( points[ 1 ], points[ 2 ] );
            children[ 1 ] = new FractalTriangle( child2Tri, this, depth + 1 );
            
            ATriangle child3Tri = makeTriangle( points[ 2 ], points[ 0 ] );
            children[ 2 ] = new FractalTriangle( child3Tri, this, depth + 1 );
        }
    ...
    private FractalTriangle ( ATriangle tri, FractalTriangle parent, int depth )
    {
        ...
        ///////////////////////////////////////////////////////////        
        _p2height = parent._p2height * sizeRatio;
        _tri = tri;
        _tri.setColor( colors[ depth - 1 ] );
        _depth = depth;
        _parent = parent;
        
        if( depth < maxDepth && depth < 6 && _p2height >= 7 )
        {
            Point[] points = _tri.getPoints();
            ATriangle child1Tri = makeTriangle( points[ 0 ], points[ 1 ] );
            children[ 0 ] = new FractalTriangle( child1Tri, this, depth + 1 );
    ...
    public void display ( Graphics2D context ) 
    {
        ...
        //
        //////////////////////////////////////////////////////
        for( FractalTriangle tri : children )
        {
            if( tri != null ) tri.display( context );
        }
    }
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
