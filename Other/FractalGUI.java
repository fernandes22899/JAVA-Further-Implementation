...
public class FractalGUI extends JPanel 
{
    ...
    private void reset()
    {
        ...
        ///////////////////////////////////////////////////////
        _heightSlider.setValue( defaultHeight );
        _sizeSlider.setValue( 50 );
        _projectionSlider.setValue( 50 );
        _offsetSlider.setValue( 50 );
        FractalTriangle.fillTriangles = true;
        FractalTriangle.outside = true;
        makeScene();      
    }
    ...
    public class SizeListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            Number slideValue = slider.getValue();
            if( slideValue.intValue() >= 5 )
            {
                double value = slideValue.intValue() / 100.0;
                FractalTriangle.sizeRatio = value;
                _baseTri = null;
                makeScene();
            }
    ...
    public class ProjectionListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            Number slideValue = slider.getValue();
            double value = slideValue.intValue() / 100.0;
            FractalTriangle.p2projection = value;
            _baseTri = null;
            makeScene();
        }
    }
