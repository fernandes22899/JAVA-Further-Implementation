...
public class Dispatcher implements Animated
{
    ...
    private ArrayList<EmergencySite> site;
    private EmergencySite _site;
    private EMTVehicle vehicle;
    ...
    /**
     * unit test.
     * @param sites EmergencySite
     */
    public void addSite ( EmergencySite sites )
    {
        site.add( sites );
    }
    /**
