...
public class BinTree
{
    ...
    public void merge( int value )
    {
        ...
        BiNode leftChild = loc._parent._left;
        BiNode rightChild = loc._parent._right;
        parent._left = null;
        parent._right = null;
        
        for( int i = 0; leftChild.getValues().size() > i; i++ )
          parent.add( leftChild.getValues().get( i ) );
        
        for( int i = 0; rightChild.getValues().size() > i; i++ )
          parent.add( rightChild.getValues().get( i ) );
