...
public class DrawPanel extends JPanel 
{
    ...
    private int       _nextY;
    private int       _nodeWidth = 52;  // space for the node
    private int       _labelWidth = 55; // width of the label for the node
    private int       _maxLabelWidth = 80; // max size of JLabel for node
