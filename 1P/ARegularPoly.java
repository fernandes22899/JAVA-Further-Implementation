...
public class ARegularPoly implements AShape
{
    ...
    private void makePolygon( int locX, int locY )
    {
        ...
        int[] xSides = new int[ _nSides ];
        int[] ySides = new int[ _nSides ];
        
        for( int i = 0; i < _nSides; i++ )
        {
            xSides[ i ] = (int)Math.round( _x[ i ] ) + locX - _ulX;
            ySides[ i ] = (int)Math.round( _y[ i ] ) + locY - _ulY;
        }
        _polygon = new java.awt.Polygon( xSides, ySides, _nSides );
    ...
    public void setRotation( int aRotation ) 
    {
        ...
        ////////////////////////////////////////////////////////////////
        int x = ( int )Math.round( _bnds.getX() );
        int y = ( int )Math.round( _bnds.getY() );
        _rotation = aRotation;
        makeVertices();
        makePolygon( x, y );
        _bnds = _polygon.getBounds();
    ...
    public void fill( java.awt.Graphics2D aBetterBrush )
    {
        ...
        aBetterBrush.setColor( defaultColor );
        
    }
    //--------------------------- draw( Graphics2D ) ---------------------
    /**
     * draw - overrides parent method.
     * @param aBrush java.awt.Graphics2D
     */
    ...
    public void setSize( int aWidth, int aHeight ) 
    {
        ...
        if( aWidth != aHeight )
        {
            System.out.print( "Error: Width and Height are different values." );
            setRadius( aWidth + aHeight / 2 );
        }
        
        makeVertices();
        makePolygon( getXLocation(), getYLocation() );
    }
    ...
    //----------------------- getXLocation() -----------------------------
    /**
     * getXLocation() - a wheels method return int value of x location.
     * @return y location
     */
    ...
    //----------------------- getYLocation() -----------------------------
    /**
     * getYLocation() - a wheels method return int value of y location.
     * @return y location
     */
     ...
     * @param aChangeInX int
     * @param aChangeInY int
     */
     ...
     * @param aBetterBrush java.awt.Graphics2D
     */
